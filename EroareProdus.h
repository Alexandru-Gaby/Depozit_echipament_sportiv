...
{
public:
    EroareProprietateProdus(const std::string& prop, const std::string &val) : EroareProdus("Proprietatea " + prop + " a primit valoarea invalida " + val){}
};

class EroareTipEchipament: public EroareProdus
{
public:
   explicit EroareTipEchipament( const std::string& tip) : EroareProdus("Tipul " +  tip +  " nu exista! "){}
};
